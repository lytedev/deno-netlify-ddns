...
lyte_dev_dns_json="$(curl -X GET "https://api.netlify.com/api/v1/dns_zones/lyte_dev/dns_records?access_token=${DEFAULT_NETLIFY_API_TOKEN}")"
test_domain_dns_json="$(curl -X GET "https://api.netlify.com/api/v1/dns_zones/fake-test-domain_tk/dns_records?access_token=${DEFAULT_NETLIFY_API_TOKEN}")"
